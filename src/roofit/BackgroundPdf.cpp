...
BackgroundPdf::BackgroundPdf(const char *name, const char *title,
        RooAbsReal& _x, 
        RooAbsReal& _threeGContrib) :
        RooAbsPdf(name, title),
	x("x", "x", this, _x),
	threeGContrib("threeGContrib", "Three gamma Fraction", this, _threeGContrib){
}

BackgroundPdf::BackgroundPdf(const BackgroundPdf& other, const char* name) : 
    RooAbsPdf(other, name),
    x("x", this, other.x),
    threeGContrib("threeGContrib", this, other.threeGContrib){    
}
