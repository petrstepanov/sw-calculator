...
ParabolaPdf::ParabolaPdf(const char *name, const char *title, RooAbsReal& _x, RooAbsReal& _mean, RooAbsReal& _r) :
		RooAbsPdf(name, title), x("x", "x", this, _x), mean("mean", "Parabola mean", this, _mean), r("r", "Parabola root", this, _r) {

}

ParabolaPdf::ParabolaPdf(const ParabolaPdf& other, const char* name) :
		RooAbsPdf(other, name), x("x", this, other.x), mean("mean", this, other.mean), r("r", this, other.r) {
}
